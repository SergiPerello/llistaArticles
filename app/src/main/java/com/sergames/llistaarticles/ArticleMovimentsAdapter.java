...
public class ArticleMovimentsAdapter extends android.widget.SimpleCursorAdapter {
    private MainActivity mainActivity;

    ArticleMovimentsAdapter(Context context, int layout, Cursor c, String[] from, int[] to, int flags) {
